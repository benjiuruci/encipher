...
public class AESEncryption {
     ...
     * @return 密文
     */
    public String encryption(String content,String secretKey,String vectorKey) throws Exception {
        //实例化加密对象
     ...
     * @return 明文
     */
    public String decrypt(String content,String secretKey,String vectorKey) throws Exception{
        //实例化加密对象
        Cipher cipher = Cipher.getInstance(Constant.AES_CBC_PKCS);
